...
To display images, you need to call TensorBoardProgressWriter.write_image method(). This function takes three arguments: name, image_data and index as shown in the example below.
```python
