...
* Introduction of [C# API in CNTK Evaluation Library](https://github.com/Microsoft/CNTK/wiki//CNTK-Library-Evaluation-on-Windows#using-the-cntk-library-managed-api) and a new set of [CNTK NuGet Packages](https://github.com/Microsoft/CNTK/wiki/NuGet-Package).
...
* [News of 2016](https://github.com/Microsoft/CNTK/wiki/News-2016)
