...
* [Save()](https://github.com/Microsoft/CNTK/tree/release/2.3/Source/CNTKv2LibraryDll/API/CNTKLibrary.h) in C++ when using [CNTK Library API](./CNTK-Library-API.md).
...
* **The model-v2 format**. With CNTK2, a Protobuf based format is introduced, which is now known as the model-v2 format. A model is saved in this format only when using [CNTK Library API](./CNTK-Library-API.md)   
  ...
  * by [Save()](https://github.com/Microsoft/CNTK/tree/release/2.3/Source/CNTKv2LibraryDll/API/CNTKLibrary.h) in C++.
