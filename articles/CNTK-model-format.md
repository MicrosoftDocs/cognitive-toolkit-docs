...
* [save()](https://docs.microsoft.com/en-us/python/api/cntk.ops.functions.function#cntk_ops_functions_Function_save) in python, or
...
* **The model-v2 format**. With CNTK2, a Protobuf based format is introduced, which is now known as the model-v2 format. A model is saved in this format only when using [CNTK Library API](./CNTK-Library-API.md)   
  * by [save()](https://docs.microsoft.com/en-us/python/api/cntk.ops.functions.function#cntk_ops_functions_Function_save) in python, or
