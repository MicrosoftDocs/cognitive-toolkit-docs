...
[CNTK Python API](https://docs.microsoft.com/en-us/python/cognitive-toolkit/) consists of abstractions for model definition and compute, learning algorithms, data reading and distributed training. 
