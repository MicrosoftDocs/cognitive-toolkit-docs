...
***2016-07-12.*** We have further expanded Licensing options for CNTK 1bit-SGD and related components. See the details at the [here](./CNTK-1bit-SGD-License.md). These new options are an extension of the new CNTK 1bit-SGD License that we have announced on Jun 23, 2016.
