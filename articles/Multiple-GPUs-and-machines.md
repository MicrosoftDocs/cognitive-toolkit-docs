...
##  2.1 Data-Parallel Training with 1-bit SGD
...
### 2.1.2 Using 1-bit SGD in BrainScript
...
### 2.1.2 Using 1-bit SGD in Python

To enable 1-bit SGD in Python the user needs to create and pass a distributed learner to the trainer:
    ...
    ...
    session = training_session(minibatch_source, trainer, ...)
    session.train()
    ...
...
### 2.2.1 The Block-Momentum SGD Algorithm
The following figure summarizes the procedure in the Block-Momentum algorithm.

![bm](figures/bm.jpg)

### 2.2.2 Configuring Block-Momentum SGD in BrainScript
...
### 2.2.3 Using Block-Momentum SGD in BrainScript
...
### 2.2.4 Using Block-Momentum in Python
...
### 2.2.4 Using Block-Momentum SGD in Python

This is work in progress.

##  2.3 Model-Averaging SGD
...
### 2.3.1 Using Model-Averaging SGD in BrainScript
...
### 2.3.2 Using Model-Averaging SGD in Python

This is work in progress.

##  2.4 Data-Parallel Training with Parameter Server
...
### 2.4.1 Using Data-Parallel ASGD
...
### 2.4.2 Configuring Data-Parallel ASGD in BrainScript
...
The following is an example of `DataParallelASGD` configuration section:
 ...
 ```
### 2.4.3 Configuring Data-Parallel ASGD in Python
