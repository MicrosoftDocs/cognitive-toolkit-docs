...
***2016-07-12.*** We have further expanded Licensing options for CNTK 1bit-SGD and related components. See the details at [here](../CNTK-1bit-SGD-License.md). These new options are an extension of the new CNTK 1bit-SGD License that we have announced on Jun 23, 2016.

***2016-07-05.*** CNTK now supports *Deconvolution* and *Unpooling*.

## June 2016
***2016-06-23.*** New License Terms for CNTK 1bit-SGD and related components. The new terms provide more flexibility and enable new usage scenarios, especially in commercial environments. More information is [here](../CNTK-1bit-SGD-License.md). Please note, that while the new terms are significantly more flexible comparing to the previous ones, they are still **more restrictive** than the main CNTK License. Consequently everything described in [Enabling 1bit-SGD](../Enabling-1bit-SGD.md) remains valid.
