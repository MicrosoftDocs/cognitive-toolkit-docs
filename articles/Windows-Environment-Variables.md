...
|CUDA_PATH | C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v9.0 |[NVIDIA CUDA]( ./Setup-CNTK-on-Windows.md#nvidia-cuda-9) (required for GPU build)
|CUDA_PATH_V9_0 | C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v9.0 |[NVIDIA CUDA]( ./Setup-CNTK-on-Windows.md#nvidia-cuda-9) (required for GPU build)
