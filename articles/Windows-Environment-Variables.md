...
|CNTK_OPENBLAS_PATH | c:\local\CNTKopenBLAS | [OpenBLAS library for CNTK UWP build](./Setup-UWP-Build-on-Windows.md) (optional. [!INCLUDE[versionadded-2.1](includes\versionadded-2.1.md)])
