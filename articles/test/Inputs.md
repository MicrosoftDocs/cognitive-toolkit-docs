...
the [`CrossEntropyWithSoftmax()`](./Loss-Functions-and-Metrics#crossentropy-crossentropywithsoftmax).
Instead, a manually-written form must be used, as [given here](./Loss-Functions-and-Metrics#sparse-labels)
