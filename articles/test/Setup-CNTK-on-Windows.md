...
This puts all the required source code for a standard build onto your system. If you plan on making modifications to the CNTK code, you should read the information on [Developing and Testing](/en-us/cognitive-toolkit/Developing-and-Testing.md) in this Wiki.
...
Build the CNTK solution. The components created by the build process are dependent on the prerequisites you installed, for details the page detailing [Windows Environment Variables](./Windows-Environment-Variables) should be consulted.
...
* [Setup CNTK Python Tools for Windows](/en-us/cognitive-toolkit/Setup-CNTK-Python-Tools-for-Windows.md)
