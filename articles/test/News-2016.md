...
See the actual news at [this page](./News).**
...
See more in the [Release Notes](./CNTK_2_0_beta_7_Release_Notes)  
...
See more in the [Release Notes](./CNTK_2_0_beta_6_Release_Notes)  
Get the Release from the [CNTK Releases page](https://github.com/Microsoft/CNTK/releases)

## November 2016
***2016-11-25.*** V 2.0 Beta 5 Release  
Highlights of this Release:
* The Windows binary packages are now created using the NVIDIA CUDA 8 toolkit, see the [release notes](./CNTK_2_0_beta_5_Release_Notes) for details. The CNTK-Linux binary packages are still built with CUDA 7.5. The Linux support for Cuda8 will follow shortly!
* Performance enhancements for evaluation of bitmap images through the new `EvaluateRgbImage` function in the [managed Eval API](./Managed-EvalDLL-API).
* A new version of the [CNTK Nuget package](./NuGet-Package) is available. 
...
See more in the [Release Notes](./CNTK_2_0_beta_5_Release_Notes)  
Get the Release from the [CNTK Releases page](https://github.com/Microsoft/CNTK/releases)
...
* New [Memory Compression](./Top-level-configurations#hypercompressmemory) mode to reduce memory usage on GPU
* CNTK Docker image with 1bit-SGD support
* Stability Improvements and bug fixes

See more in the [Release Notes](./CNTK_2_0_beta_4_Release_Notes)  
Get the Release from the [CNTK Releases page](https://github.com/Microsoft/CNTK/releases)

***2016-11-11.*** V 2.0 Beta 3 Release  
Highlights of this Release:
* Integration with [NVIDIA NCCL](https://github.com/NVIDIA/nccl). Works with Linux when building CNTK from sources. See here [how to enable](./Setup-CNTK-on-Linux#optional-nccl)
* The first V.2.0 Prerelease Nuget Package for CNTK Evaluation library
* Stability Improvements and bug fixes

See more in the [Release Notes](./CNTK_2_0_beta_3_Release_Notes)  
Get the Release from the [CNTK Releases page](https://github.com/Microsoft/CNTK/releases)
...
See more in the [Release Notes](./CNTK_2_0_beta_2_Release_Notes)  
Get the Release from the [CNTK Releases page](https://github.com/Microsoft/CNTK/releases)
...
See more in the [Release Notes](./CNTK_2_0_beta_1_Release_Notes). You will find there links to the materials about the new features.  
Get the Release from the [CNTK Releases page](https://github.com/Microsoft/CNTK/releases)
...
See more in the [Release Notes](./CNTK_1_7_1_Release_Notes) (including the full list of bugs fixed)  
Get the Release from the [CNTK Releases page](https://github.com/Microsoft/CNTK/releases)
...
See more in the [Release Notes](./CNTK_1_7_Release_Notes)  
Get the Release from the [CNTK Releases page](https://github.com/Microsoft/CNTK/releases)

***2016-08-29.*** Two new Tutorials are available:  
[Image recognition](./Hands-On-Labs-Image-Recognition) (CIFAR-10) and [Language understanding](./Hands-On-Labs-Language-Understanding) (ATIS).

***2016-08-10.*** We have significantly simplified handling of **Gated Recurrent Units (GRU)**. Read more in the [corresponding article](./GRUs-on-CNTK-with-BrainScript).
...
See more in the [Release Notes](./CNTK_1_6_Release_Notes)  
Get the Release from the [CNTK Releases page](https://github.com/Microsoft/CNTK/releases)
...
NuGet Package is added to CNTK v.1.5 binaries. See [CNTK Releases page](https://github.com/Microsoft/CNTK/releases) and [NuGet Package description](./Nuget-Package-for-Evaluation).

***2016-06-15.***  CNTK now supports building against a custom Intel® Math Kernel Library (MKL).
See [setup instructions](./Setup-CNTK-on-your-machine) on how to set this up for your platform.
...
***2016-06-01.*** An updated version of the network-description language has been made available under the new [BrainScript Network Builder](./BrainScript-Network-Builder), which features full expression parsing, recursive functions, and more.

## May 2016
***2016-05-19.*** A 1-hour talk describing CNTK, how to use it, and how it works, has been posted at [Presentations](./Presentations).
...
***2016-05-16.*** CNTK Wiki now has [FAQ Page](./CNTK-FAQ)

***2016-05-05.*** CNTK now supports *BlockMomentum* Stochastic Gradient Descent (SGD) algorithm.  
See the details in the [Multiple GPUs and machines Wiki section](./Multiple-GPUs-and-machines)

***2016-05-03.*** New transformations are implemented for **Image Reader**.  
See the description in the [Image Reader Wiki section](./Image-reader)
...
***2016-04-12.*** CNTK is available as [Azure Virtual Machines](./CNTK-on-Azure) and [Docker Containers](./CNTK-Docker-Containers)
...
Read [documentation](./Full-NDL-Function-Reference) on convolution, pooling and batch normalization nodes.
