...
* New Tutorials and Examples:
  ...
  * [Basic implementation of Generative Adversarial Networks (GAN.md) networks](https://github.com/Microsoft/CNTK/blob/v2.0.beta10.0/Tutorials/CNTK_206_Basic_GAN.ipynb)
...
Effective January 25, 2017 CNTK [1-bit Stochastic Gradient Descent (1bit-SGD.md)](./Enabling-1bit-SGD.md) and [BlockMomentumSGD](./Multiple-GPUs-and-machines#22-block-momentum-sgd.md) code is moved to a new Repository in GitHub.
...
Get the Release from the [CNTK Releases page](https://github.com/Microsoft/CNTK/releases.md).
