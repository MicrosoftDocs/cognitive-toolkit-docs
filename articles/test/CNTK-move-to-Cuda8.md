...
Install the appropriate version of [NVIDIA CUDA Deep Neural Network library (cuDNN)](https://developer.NVIDIA.com/cuDNN). Installation procedure is described in this [CNTK Wiki Section](./Setup-CNTK-on-Linux#cudnn). 
